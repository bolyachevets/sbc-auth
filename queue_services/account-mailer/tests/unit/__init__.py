...
def factory_user_model_with_contact():
    ...
    user_info = {"username": "foo", "firstname": "bar", "lastname": "User", "keycloak_guid": uuid.uuid4()}
...
def factory_membership_model(user_id, org_id, member_type="ADMIN", member_status=1):
    ...
    membership = MembershipModel(
        user_id=user_id, org_id=org_id, membership_type_code=member_type, membership_type_status=member_status
    )
...
def factory_contact_model():
    ...
    contact_info = {"email": "foo@bar.com", "phone": "(555) 555-5555", "phoneExtension": "123"}
...
class TestUserInfo(dict, Enum):
    ...
    user1 = {"username": "foo", "firstname": "bar", "lastname": "User", "keycloak_guid": uuid.uuid4()}
